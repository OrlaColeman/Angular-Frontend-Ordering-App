...
@Component({
  selector: 'app-marys-fish',
  templateUrl: './marys-fish.component.html',
  styleUrls: ['./marys-fish.component.css']
})
export class MarysFishComponent implements OnInit {
name: string
userID: number
companyID: number 
orderID: number
...
productsOrdered : productOrder[];
  ...
  ngOnInit() {
    ...
    this.service.retrieveCompanyID("Mary's Fish Shop").subscribe(data => this.handleCompanyData(data));
