...
@Component({
  selector: 'app-total-produce',
  templateUrl: './total-produce.component.html',
  styleUrls: ['./total-produce.component.css']
})
export class TotalProduceComponent implements OnInit {
  name: string
  userID: number
  companyID: number 
  orderID: number
  ...
  productsOrdered : productOrder[];
    ...
    ngOnInit() {
      ...
      this.service.retrieveCompanyID("Total Produce").subscribe(data => this.handleCompanyData(data));
